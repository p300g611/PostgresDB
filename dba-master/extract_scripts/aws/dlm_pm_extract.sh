...
python /srv/extracts/source/extract_sqlite.py -a "3" -y "2018"  -d /srv/extracts/data/dlm.pm.sqlite -t "all"  -n "host='aartdb-prod.c4d5gwuuaeq5.us-east-1.rds.amazonaws.com' dbname='aartprod' user='aart_reader'"
DLM_EXIT_STATUS=$?
...
aws s3 mv s3://kite-sqlite-extracts/data/DLM/dlm.pm.sqlite s3://kite-sqlite-extracts/data/DLM/dlm.pm.sqlite-old >/dev/null
aws s3 cp /srv/extracts/data/dlm.pm.sqlite s3://kite-sqlite-extracts/data/DLM/dlm.pm.sqlite >/dev/null