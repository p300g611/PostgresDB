...
python /srv/extracts/source/extract_sqlite.py -a "3" -y "2018" -d /srv/extracts/data/dlm.am.sqlite -t "all" -n "host='pg3.prodku.cete.us' dbname='aart-prod' user='aart_reader'"
DLM_EXIT_STATUS=$?
