...
echo $(date) >> clickhistory_start0403.out
...
TGT_BUCKET_NAME="s3://kite-sqlite-extracts/tmp/test/clickhistoryprod"
...
do   
	...
	for file in $( aws s3 ls "$SRC_BUCKET_NAME"/ | awk '$1="$DATE_FORMAT" {print $4}'); do
        #echo $file;
...
#aws s3 ls s3://kite-clickhistory-prod --recursive | awk -v mydate="$(date +"%Y-%m-%d ")" '$1=mydate {print $4}'
...
#aws s3 ls s3://kite-clickhistory-prod --recursive | grep "1214825-21093237"
#aws s3 ls s3://kite-clickhistory-prod --recursive | awk  '$1=2018-04-03 {print $4}' | grep "1214825-32483966"
#aws s3 ls s3://kite-clickhistory-prod --recursive | awk  '$1=2018-04-03 {print $4}' | grep "1214825-21093237"

echo $(date) >> clickhistory_end0403.out