--1.a:update: Find the all mandatory questions were not answered and iscompleted set true
...
and fcss.scienceflag is true and sl.globalpagenum =16
...
-- 1.b:update: Find the all mandatory questions were answered and iscompleted set false
update surveypagestatus
