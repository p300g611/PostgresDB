...
\COPY tmp_scenario4_raw FROM '/CETE_GENERAL/Technology/helpdesk/scenarios/unprocessed/scenario4.csv' DELIMITER ',' CSV HEADER
...
\COPY (SELECT * FROM tmp_scenario4 WHERE error_msg ilike '%<error>%') TO '/CETE_GENERAL/Technology/helpdesk/scenarios/scenario4_error.csv' DELIMITER ',' CSV HEADER
