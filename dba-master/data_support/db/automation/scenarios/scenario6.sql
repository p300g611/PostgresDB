...
\COPY tmp_scenario6_raw FROM '/CETE_GENERAL/Technology/helpdesk/scenarios/unprocessed/scenario6.csv' DELIMITER ',' CSV HEADER
...
END;
$BODY$;
\COPY (select * from tmp_scenario6 where error_msg ilike '%<error>%' ) to '/CETE_GENERAL/Technology/helpdesk/scenarios/scenario6_error.csv' DELIMITER ',' CSV HEADER
drop table if exists  tmp_scenario6 ;
drop table if exists  tmp_scenario6_raw ;
