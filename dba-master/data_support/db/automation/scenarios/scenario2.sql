...
\COPY tmp_scenario2_raw FROM '/CETE_GENERAL/Technology/helpdesk/scenarios/unprocessed/scenario2.csv' DELIMITER ',' CSV HEADER
...
END;
$BODY$;
\COPY (select * from tmp_scenario2 where error_msg ilike '%<error>%' ) to '/CETE_GENERAL/Technology/helpdesk/scenarios/scenario2_error.csv' DELIMITER ',' CSV HEADER
drop table if exists  tmp_scenario2 ;
drop table if exists  tmp_scenario2_raw ;
