...
now_date :=now();
	...
	select      'szielasko@moric.org' username, 
		    'Sally' firstname, 
		     null middlename, 
		    'Zielasko' surname, 
		    ...
		    12 modifieduser, 
		    'Sally Zielasko' displayname;
		    
	  RAISE NOTICE 'new user added to aartusert table:szielasko@moric.org'; 
	...
	select      'mrocker@moric.org' username, 
		    'Maria' firstname, 
		     null middlename, 
		    'Rocker' surname, 
		    '307a08d319561af5b495da6c6c65f5bf0b094592c7799d68f058a5f4f6bb6ca35826eba6bb3202746b13cc92df7d1c25688a166cde17c44d0eb16f22b05731f1' as "password", 
		    'mrocker@moric.org' email, 
		    '' uniquecommonidentifier, 
		    0 defaultusergroupsid, 
		    'mxokvhdsihffdsyj' ukey, 
		    now_date createddate, 
		    ...
		    now_date modifieddate, 
		    12 modifieduser, 
		    'Maria Rocker' displayname;
	  RAISE NOTICE 'new user added to aartusert table:mrocker@moric.org'; 
	  
	

FOR art_userid IN (select id from aartuser where email in ('szielasko@moric.org' ,'mrocker@moric.org'))
