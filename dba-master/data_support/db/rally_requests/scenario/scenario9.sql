...
\COPY tmp_scenario9_raw FROM 'scenario9.csv' DELIMITER ',' CSV HEADER ;
...
END;
$BODY$;
\COPY (select * from tmp_scenario9 where error_msg ilike '%<error>%' ) to 'scenario9_error.csv' DELIMITER ',' CSV HEADER ;
drop table if exists  tmp_scenario9 ;
drop table if exists  tmp_scenario9_raw ;