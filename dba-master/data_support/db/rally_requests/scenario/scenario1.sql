...
\COPY tmp_scenario1_raw FROM 'scenario1.csv' DELIMITER ',' CSV HEADER ;   
...
END;
$BODY$;
\COPY (select * from tmp_scenario1 where error_msg ilike '%<error>%' ) to 'scenario1_error.csv' DELIMITER ',' CSV HEADER ;
drop table if exists  tmp_scenario1 ;
drop table if exists  tmp_scenario1_raw ;