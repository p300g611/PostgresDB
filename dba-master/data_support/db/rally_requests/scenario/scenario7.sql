...
\COPY tmp_scenario7_raw FROM 'scenario7.csv' DELIMITER ',' CSV HEADER ; 
...
END;
$BODY$;
\COPY (select * from tmp_scenario7 where error_msg ilike '%<error>%' ) to 'scenario7_error.csv' DELIMITER ',' CSV HEADER ;
drop table if exists  tmp_scenario7 ;
drop table if exists  tmp_scenario7_raw ;