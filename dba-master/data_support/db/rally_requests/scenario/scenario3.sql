...
\COPY tmp_scenario3_raw FROM 'scenario3.csv' DELIMITER ',' CSV HEADER ;
...
END;
$BODY$;
\COPY (select * from tmp_scenario3 where error_msg ilike '%<error>%' ) to 'scenario3_error.csv' DELIMITER ',' CSV HEADER ;
drop table if exists  tmp_scenario3 ;
drop table if exists  tmp_scenario3_raw ;