...
where st.activeflag is true 
 and e.currentschoolyear=2017 AND tp.programname ='Summative'  and ap.id=12 and tc.contentareaid=3 and gc.abbreviatedname='3';
...
\copy (select * from tmp_final_extract) to 'kap_extract_ela_grade3.txt' (FORMAT CSV,DELIMITER('|'), HEADER TRUE, FORCE_QUOTE *);
