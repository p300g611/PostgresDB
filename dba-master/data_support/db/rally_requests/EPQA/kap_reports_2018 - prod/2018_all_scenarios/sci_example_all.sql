...
-- insert into tmp_epqa_exclude
 ...
 -- where externalid in (
 -- select distinct taskvariantid from excludeditems where schoolyear = 2018 and assessmentprogramid = 12 and subjectid = 441);
...
where rpm.assessmentprogramid =12 and rpm.contentareaid=441  and rpm.schoolyear=2018  and rpm.subscoredefinitionname  is null
 and drpm.assessmentprogramid =12 and drpm.contentareaid=441 and drpm.schoolyear=2018 and drpm.subscoredefinitionname is null 
 and srpm.assessmentprogramid =12 and srpm.contentareaid=441 and srpm.schoolyear=2018 and srpm.subscoredefinitionname is null
...
where sr.schoolyear=2018 and sr.assessmentprogramid=12 and sr.contentareaid=441
