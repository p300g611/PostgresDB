...
--=============================================================================================================================
--[SCI,KS,KAP,scenario1]:stage1:Complete < 5 included answered. stage2:In Progress or In Progress Timed Out => 5 included answered
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg2 as (
select 
 st.studentid
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios1.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;
--=============================================================================================================================
--[SCI,KS,KAP,scenario2]:stage1:Complete < 5 included answered. stage2:Complete => 5 included answered
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios2.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;
--=============================================================================================================================
--[SCI,KS,KAP,scenario3]:stage1:Complete >= 5 included anwered. stage2:In Progress or In Progress Timed Out < 5 included answered
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios3.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;

--=============================================================================================================================
--[SCI,KS,KAP,scenario4]:stage1:Complete >= 5 included anwered. stage2:Complete < 5 included answered
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios4.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;

--=============================================================================================================================
--[SCI,KS,KAP,scenario5]:stage1:Complete >= 5 included anwered. stage2:In Progress or In Progress Timed Out >= 5 answered
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios5.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;
--=============================================================================================================================
--[SCI,KS,KAP,scenario6]:stage1:Complete < 5 included answered. stage2:unused
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios6.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;

--=============================================================================================================================
--[SCI,KS,KAP,scenario7]:stage1:Complete >= 5 included answered. stage2:unused
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios7.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;

--=============================================================================================================================
--[SCI,KS,KAP,scenario8]:In Progress or In Progress Timed Out < 5 included answered. 
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg1 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios8.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_sci_scenarios;

--=============================================================================================================================
--[SCI,KS,KAP,scenario9]:In Progress or In Progress Timed Out >= 5 included answered. 
--===============================================================================================================================
drop table if exists tmp_sci_scenarios;
with cte_stg1 as (
select 
...
\copy (select * from tmp_sci_scenarios) to 'tmp_sci_scenarios9.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
