...
where st.activeflag is true and ts.operationaltestwindowid in (10251,10252)  and ts.schoolyear=2018  and st.status in (86,85,659)
...
--=============================================================================================================================
--[HGSS,KS,KAP,scenario24]:Transfer In or Out of district---OUT; Transfer before after Stage 1 or Stage 2--- After Stage 2
--===============================================================================================================================
...
and ts.operationaltestwindowid in (10251,10252) and tc.contentareaid=443 and stg.code='Prfrm' 
...
and ts.source='BATCHAUTO' and ts.operationaltestwindowid in (10251,10252)
