...
--=============================================================================================================================
--[ELA,KS,KAP,scenario1]:stage1:Complete < 5 included answered. stage2:In Progress or In Progress Timed Out => 5 included answered
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg2 as (
select 
 st.studentid
...
and ts.operationaltestwindowid in (10261) and tc.contentareaid=3 and stg.code='Stg2' 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios1.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;
--=============================================================================================================================
--[ELA,KS,KAP,scenario2]:stage1:Complete < 5 included answered. stage2:Complete => 5 included answered
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios2.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;
--=============================================================================================================================
--[ELA,KS,KAP,scenario3]:stage1:Complete >= 5 included anwered. stage2:In Progress or In Progress Timed Out < 5 included answered
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios3.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;

--=============================================================================================================================
--[ELA,KS,KAP,scenario4]:stage1:Complete >= 5 included anwered. stage2:Complete < 5 included answered
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios4.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;

--=============================================================================================================================
--[ELA,KS,KAP,scenario5]:stage1:Complete >= 5 included anwered. stage2:In Progress or In Progress Timed Out >= 5 answered
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios5.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;
--=============================================================================================================================
--[ELA,KS,KAP,scenario6]:stage1:Complete < 5 included answered. stage2:unused
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios6.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;

--=============================================================================================================================
--[ELA,KS,KAP,scenario7]:stage1:Complete >= 5 included answered. stage2:unused
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg2 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios7.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;

--=============================================================================================================================
--[ELA,KS,KAP,scenario8]:In Progress or In Progress Timed Out < 5 included answered.
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg1 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios8.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

drop table if exists tmp_ela_scenarios;

--=============================================================================================================================
--[ELA,KS,KAP,scenario9]:In Progress or In Progress Timed Out >= 5 included answered. 
--===============================================================================================================================
drop table if exists tmp_ela_scenarios;
with cte_stg1 as (
select 
...
\copy (select * from tmp_ela_scenarios) to 'tmp_ela_scenarios9.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
