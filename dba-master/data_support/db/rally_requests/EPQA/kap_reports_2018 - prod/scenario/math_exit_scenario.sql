...
--=============================================================================================================================
--[Math,KS,KAP, scenario2]:Stage 1:In Progress or In Progress Timed Out => 5 included answered. Stage 2: unused.
--===============================================================================================================================

drop table if exists tmp_math_exit_scenarios;
with cte_stg1 as (
select 
 st.studentid
...
and ts.source='BATCHAUTO' and ts.operationaltestwindowid in (10261)
where (ts.source='BATCHAUTO' and ts.operationaltestwindowid in (10261)  and st.status =477 and st.startdatetime is null ) or st.id is null  
)
select distinct
...
into temp tmp_math_exit_scenarios
from cte_stg1 stg1
...
\copy (select * from tmp_math_exit_scenarios) to 'tmp_math_exit_scenarios2.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

--=============================================================================================================================
--[Math,KS,KAP, scenario6]:Stage 1: Complete => included 5 answered. Stage: 2 unused
--===============================================================================================================================
...
\copy (select * from tmp_math_exit_scenarios) to 'tmp_math_exit_scenarios6.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);


--=============================================================================================================================
--[Math,KS,KAP, scenario10]:Stage 2: In Progress or In Progress Timed Out => included 5 answered.
--===============================================================================================================================
...
\copy (select * from tmp_math_exit_scenarios) to 'tmp_math_exit_scenarios10.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);



--=============================================================================================================================
--[Math,KS,KAP, scenario14]:Stage 2: Complete => 5 included answered.
--===============================================================================================================================
...
\copy (select * from tmp_math_exit_scenarios) to 'tmp_math_exit_scenarios14.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
