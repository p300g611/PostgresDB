...
--=============================================================================================================================
--[HGSS,KS,KAP, scenario4]:Stage 1:In Progress or In Progress Timed Out => 5 included answered. Stage 2: unused.
--===============================================================================================================================

drop table if exists tmp_ss_exit_scenarios;
with cte_stg1 as (
select 
 st.studentid
...
left outer join testsession ts on st.testsessionid=ts.id and ts.schoolyear=2018 and ts.stageid=3
...
into temp tmp_ss_exit_scenarios
from cte_stg1 stg1
...
\copy (select * from tmp_ss_exit_scenarios) to 'tmp_ss_exit_scenarios4.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);

--=============================================================================================================================
--[HGSS,KS,KAP, scenario8]:Stage 1: Complete => included 5 answered. Stage: 2 unused
--===============================================================================================================================
...
and not exists (select 1 from studentstests stt join testsession tts on stt.testsessionid=tts.id and tts.schoolyear=2018 and tts.stageid=3
...
\copy (select * from tmp_ss_exit_scenarios) to 'tmp_ss_exit_scenarios8.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);


--=============================================================================================================================
--[HGSS,KS,KAP, scenario12]:Stage 2: In Progress or In Progress Timed Out => included 5 answered.
--===============================================================================================================================
...
\copy (select * from tmp_ss_exit_scenarios) to 'tmp_ss_exit_scenarios12.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);



--=============================================================================================================================
--[HGSS,KS,KAP, scenario16]:Stage 2: Complete => 5 included answered.
--===============================================================================================================================
...
\copy (select * from tmp_ss_exit_scenarios) to 'tmp_ss_exit_scenarios16.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
