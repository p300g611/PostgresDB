...
--==========================================================================================================
--Not changing as it is already validted.
...
--=========================================================================================================
--Scenario11[ELA,KS,KAP,Report]:(1)Stage_1_Status>5 (2)Stage_2_Status=in process time out=5 (3)Score_Report=yes          
--==========================================================================================================
...
--=========================================================================================================
--Scenario12[ELA,KS,KAP,Report]:(1)Stage_1_Status>5 (2)Stage_2_Status=in process time out=5 (3)Score_Report=yes          
--==========================================================================================================
...
left outer join leveldescription ld1 on sr.previousyearlevelid=ld1.id
where e.currentschoolyear=2017 and sap.assessmentprogramid=12 and sub.id=17 and tt.id=2
--and (ot.districtid in (203, 394) or otstg1.districtid in (203, 394))
...
and stg1.stg1_schoolid= ot.schoolid
