...
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=17 and std.id is not null and std.status=84  then st_studentid else null end ) stage_ELA_Stg1_unused
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=17 and std.id is not null and std.status=85  then st_studentid else null end ) stage_ELA_Stg1_inprogress
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=17 and std.id is not null and std.status=86  then st_studentid else null end ) stage_ELA_Stg1_completed
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=1 and std.id is not null and std.status=84 then st_studentid else null end ) stage_Math_Stg1_unused
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=1 and std.id is not null and std.status=85 then st_studentid else null end ) stage_Math_Stg1_inprogress
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=1 and std.id is not null and std.status=86 then st_studentid else null end ) stage_Math_Stg1_completed
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=19 and std.id is not null and std.status=84 then st_studentid  else null end ) stage_Sci_Stg1_unused
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=19 and std.id is not null and std.status=85 then st_studentid else null end ) stage_Sci_Stg1_inprogress
-- ,count(distinct case when std.code='Stg1' and st_subjectareaid=19 and std.id is not null and std.status=86 then st_studentid else null end ) stage_Sci_Stg1_completed
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=17 and std.id is not null and std.status=84 then st_studentid else null end ) stage_ELA_Stg2_unused
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=17 and std.id is not null and std.status=85 then st_studentid else null end ) stage_ELA_Stg2_inprogress
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=17 and std.id is not null and std.status=86 then st_studentid else null end ) stage_ELA_Stg2_completed
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=1 and std.id is not null and std.status=84 then st_studentid else null end ) stage_Math_Stg2_unused
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=1 and std.id is not null and std.status=85 then st_studentid else null end ) stage_Math_Stg2_inprogress
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=1 and std.id is not null and std.status=86 then st_studentid else null end ) stage_Math_Stg2_completed
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=19 and std.id is not null and std.status=84 then st_studentid else null end ) stage_Sci_Stg2_unused
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=19 and std.id is not null and std.status=85 then st_studentid else null end ) stage_Sci_Stg2_inprogress
-- ,count(distinct case when std.code='Stg2' and st_subjectareaid=19 and std.id is not null and std.status=86 then st_studentid else null end ) stage_Sci_Stg2_completed
into temp tmp_epqa
 from tmp_merge std 
...
\copy (select * from tmp_epqa) to 'kap_withsubject.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
