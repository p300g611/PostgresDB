...
drop table if exists tmp_epqa_allscenarios_g7;
...
into temp tmp_epqa_allscenarios_g7
from cte_stg1 stg1 
...
\copy (select * from tmp_epqa_allscenarios_g7) to 'tmp_epqa_allscenarios_ela_grade7.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
