...
where 
-- st.studentid = (select id from student where stateid = 51 and statestudentidentifier = '2457640768') and
...
\copy (select * from tmp_epqa_allscenarios_math) to 'math_grade7.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
