...
,max(case when rss.subscoredefinitionname='Claim_2_Rpt_Group_1' then rss.subscorerawscore end) "Claim_2_Rpt_Group_1"
,max(case when rss.subscoredefinitionname='Claim_2_Rpt_Group_2' then rss.subscorerawscore end) "Claim_2_Rpt_Group_2"
,max(case when rss.subscoredefinitionname='Claim_2_Rpt_Group_3' then rss.subscorerawscore end) "Claim_2_Rpt_Group_3"   
...
,sum(case when rms.subscoredefinitionname='Claim_2_Rpt_Group_1' then rms.itemsresponded end)   "Claim_2_Rpt_Group_1_W_Responses"
,sum(case when rms.subscoredefinitionname='Claim_2_Rpt_Group_2' then rms.itemsresponded end)   "Claim_2_Rpt_Group_2_W_Responses"
,sum(case when rms.subscoredefinitionname='Claim_2_Rpt_Group_3' then rms.itemsresponded end)   "Claim_2_Rpt_Group_3_W_Responses"
...
,sum(case when rms.subscoredefinitionname='Claim_2_Rpt_Group_1' then rms.totalitemsincluded end) "Claim_2_Rpt_Group_1_Included"
,sum(case when rms.subscoredefinitionname='Claim_2_Rpt_Group_2' then rms.totalitemsincluded end) "Claim_2_Rpt_Group_2_Included"
,sum(case when rms.subscoredefinitionname='Claim_2_Rpt_Group_3' then rms.totalitemsincluded end) "Claim_2_Rpt_Group_3_Included"
...
,"Claim_2_Rpt_Group_1_W_Responses"
,"Claim_2_Rpt_Group_2_W_Responses"
,"Claim_2_Rpt_Group_3_W_Responses"
...
,"Claim_2_Rpt_Group_1_Included"
,"Claim_2_Rpt_Group_2_Included"
,"Claim_2_Rpt_Group_3_Included"
...
,''::Char(1)  "Claim_2_Rtp_Group_1_Min_Respoonses"
,''::Char(1)  "Claim_2_Rtp_Group_2_Min_Respoonses"
,''::Char(1)  "Claim_2_Rtp_Group_3_Min_Respoonses"
...
,Claim_2_Rpt_Group_1_rating "Claim_2_Rpt_Group_1_Rating"
,Claim_2_Rpt_Group_2_rating "Claim_2_Rpt_Group_2_Rating"
,Claim_2_Rpt_Group_3_rating "Claim_2_Rpt_Group_3_Rating"
...
left outer join  leveldescription lev on lev.id=sr.levelid and lev.schoolyear=2017 and lev.assessmentprogramid=12 and lev.subjectid=3
