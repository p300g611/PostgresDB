...
drop table if exists tmp_epqa_allscenarios_g3;
with cte_stg2 as (
select distinct
 st.studentid
...
into temp tmp_epqa_allscenarios_g3
from cte_stg1 stg1 
...
\copy (select * from tmp_epqa_allscenarios_g3) to 'tmp_epqa_allscenarios_ela_grade3.csv' (FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
