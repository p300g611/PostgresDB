...
--,ca.name Assessment
 ,sc.cedscode "Special_Circumstance_Code"
 ,sc.specialcircumstancetype "Special_Circumstance_Label"
 ,cfd.contentcode "Essential_Element" -- dlm mapping table 
...
and  ts.operationaltestwindowid in (10273,10286,10295,10284,10293,10276,10291,10278,10282,10280,10288,10259,10264,10266,10305,10290)  --we need to uncomment ***WRANING**
;
...
inner join contentarea ca on ca.id=tc.contentareaid
where ts.schoolyear=2018 and s.stateid=51
and ts.source in ('BATCHAUTO','FIXBATCH')-- we need to confirm on this 
and  ts.operationaltestwindowid in (10201,10270)  --we need to uncomment ***WRANING**
;
