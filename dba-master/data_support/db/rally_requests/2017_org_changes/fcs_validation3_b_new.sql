...
select count(*)
 from page2_q19 tgt
inner join surveypagestatus sp on sp.surveyid=tgt.surveyid and sp.globalpagenum=tgt.globalpagenum and iscompleted is false
join page2_nq19 src on tgt.surveyid=src.surveyid
--where src.surveyid is null;
-- │ count │
-- ├───────┤
-- │     0 │
...
(
 ...
 inner join surveylabel sl on sr.labelid = sl.id and sp.globalpagenum=sl.globalpagenum
 where e.currentschoolyear=2017 and fcss.schoolyear=2017  and fcss.categoryid=568 and sp.iscompleted is true 
    and sp.globalpagenum=2 and sl.labelnumber ='Q19'  and sr.responseorder=2 --and optional is false
),page2_nq19 as 
(
 select distinct sp.id pageid,sp.surveyid,sp.globalpagenum  
 from survey sv
...
(
 ...
 inner join surveylabel sl on sr.labelid = sl.id and sp.globalpagenum=sl.globalpagenum
 where e.currentschoolyear=2017 and fcss.schoolyear=2017  and fcss.categoryid=568 --and sp.iscompleted is true 
    and sp.globalpagenum=2 and sl.labelnumber ='Q19'  and sr.responseorder=3 --and optional is false
),page2_nq19 as 
(
 select distinct sp.id pageid,sp.surveyid,sp.globalpagenum  
 from survey sv
...
(
 ...
 inner join surveylabel sl on sr.labelid = sl.id and sp.globalpagenum=sl.globalpagenum
 where e.currentschoolyear=2017 and fcss.schoolyear=2017  and fcss.categoryid=568 --and sp.iscompleted is true 
    and sp.globalpagenum=3 and sl.labelnumber ='Q22'  and sr.responseorder=3 --and optional is false
),page2_nq19 as 
(
 select distinct sp.id pageid,sp.surveyid,sp.globalpagenum  
 from survey sv
...
(
 ...
 inner join surveylabel sl on sr.labelid = sl.id and sp.globalpagenum=sl.globalpagenum
 where e.currentschoolyear=2017 and fcss.schoolyear=2017  and fcss.categoryid=568 --and sp.iscompleted is true 
    and sp.globalpagenum=3 and sl.labelnumber ='Q22'  and sr.responseorder=4 --and optional is false
),page2_nq19 as 
(
 select distinct sp.id pageid,sp.surveyid,sp.globalpagenum  
 from survey sv
...
(
 ...
 inner join surveylabel sl on sr.labelid = sl.id and sp.globalpagenum=sl.globalpagenum
 where e.currentschoolyear=2017 and fcss.schoolyear=2017  and fcss.categoryid=568 and sp.iscompleted is true 
    and sp.globalpagenum=3 and sl.labelnumber ='Q23'  and sr.responseorder=3 --and optional is false
),page2_nq19 as 
(
 select distinct sp.id pageid,sp.surveyid,sp.globalpagenum  
 from survey sv
...
(
 ...
 inner join surveylabel sl on sr.labelid = sl.id and sp.globalpagenum=sl.globalpagenum
 where e.currentschoolyear=2017 and fcss.schoolyear=2017  and fcss.categoryid=568 --and sp.iscompleted is true 
    and sp.globalpagenum=5 and sl.labelnumber ='Q143'  and sr.responseorder in (1,2,3) --and optional is false
),page2_nq19 as 
(
 select distinct sp.id pageid,sp.surveyid,sp.globalpagenum  
 from survey sv
...
(
 ...
 inner join surveylabel sl on sr.labelid = sl.id and sp.globalpagenum=sl.globalpagenum
 where e.currentschoolyear=2017 and fcss.schoolyear=2017  and fcss.categoryid=568 --and sp.iscompleted is true 
    and sp.globalpagenum=5 and sl.labelnumber ='Q143'  and sr.responseorder in (4,5) --and optional is false
),page2_nq19 as 
(
 select distinct sp.id pageid,sp.surveyid,sp.globalpagenum  
 from survey sv
...
select count(*)
 from page6_q19 tgt
 inner join surveypagestatus sp on sp.surveyid=tgt.surveyid and sp.globalpagenum=tgt.globalpagenum and iscompleted is false
join page6_nq19 src on tgt.surveyid=src.surveyid
--where src.surveyid is null;
;
-- │ count │
-- ├───────┤
...
--select tgt.surveyid ,sp.globalpagenum,sp.iscompleted,sp.id pageid
 select count(distinct tgt.surveyid)
 from page678 tgt
inner join surveypagestatus sp on sp.surveyid=tgt.surveyid 
 join page9_nq19 src on tgt.surveyid=src.surveyid and sp.globalpagenum=src.globalpagenum and iscompleted is false
