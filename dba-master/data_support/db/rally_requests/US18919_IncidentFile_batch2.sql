...
-- Find the student and codes related to window(EOI)(need to eliminate if test name like "R-")
  select distinct statestudentidentifier,
		    ...
		    where stb.operationalwindowid in (10157,10151,10138,10142,10153,10155) and
		          s.stateid in (35999,51,9632,9634,9592,9633,9588,9631)
...
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee order by 1) TO 'tmp_Incidentfile_ee1.csv' DELIMITER ',' CSV HEADER;--(FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,grf contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee order by 1) TO 'tmp_Incidentfile_grf1.csv' DELIMITER ',' CSV HEADER;
...
select distinct statestudentidentifier,
		    ...
		    where stb.operationalwindowid in (10157,10151,10136,10138,10141,10142,10152,10153,10155,10156) and 
		     s.stateid in (35999,51,9632,9634,9592,9633,9588,9631)
...
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee2 order by 1) TO 'tmp_Incidentfile_ee2.csv' DELIMITER ',' CSV HEADER;--(FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,grf contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee2 order by 1) TO 'tmp_Incidentfile_grf2.csv' DELIMITER ',' CSV HEADER;
...
--issue cod:5 Testing on two devices (test returns to unused status and scores show as NA; Spring and ITI)
 ...
 select  distinct statestudentidentifier,
     ...
     where ( (ts.operationaltestwindowid in (10119,10123,10136,10138,10141,10142,10143,10148,
                                           10149,10150,10151,10152,10153,10155,10156,10157) and t.testname not like '%R-%')or t.testname ilike '%ITI%')  and 
     s.stateid in (35999,51,9632,9634,9592,9633,9588,9631)       
     and  sres1.studentstestsid is null 
				--and str.activeflag is true 
				--and stb.activeflag is true 
...
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee5 order by 1) TO 'tmp_Incidentfile_ee5.csv' DELIMITER ',' CSV HEADER;--(FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,grf contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee5 order by 1) TO 'tmp_Incidentfile_grf5.csv' DELIMITER ',' CSV HEADER;
...
select distinct s.id
 ...
 where piac.attributecontainer='Braille' and pia.attributename = 'assignedSupport' and spav.selectedvalue ='true'
       and  s.stateid in (35999,51,9632,9634,9592,9633,9588,9631);
...
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee4 order by 1) TO 'tmp_Incidentfile_ee4.csv' DELIMITER ',' CSV HEADER;--(FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,grf contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee4 order by 1) TO 'tmp_Incidentfile_grf4.csv' DELIMITER ',' CSV HEADER;
...
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee3 order by 1) TO 'tmp_Incidentfile_ee3.csv' DELIMITER ',' CSV HEADER;--(FORMAT CSV, HEADER TRUE, FORCE_QUOTE *);
\copy (SELECT distinct statestudentidentifier,legallastname,legalfirstname,generationcode,dateofbirth,grf contentframeworkdetailcode,issue_code,state FROM tmp_Incidentfile_ee3 order by 1) TO 'tmp_Incidentfile_grf3.csv' DELIMITER ',' CSV HEADER;
