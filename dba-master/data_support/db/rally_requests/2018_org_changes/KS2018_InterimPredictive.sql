...
/*
 --Only for moodle extract feature testing
begin;
INSERT INTO public.moodleupload(aartuserid, schoolyear, email, course, createddate, createduser, 
            modifieddate, modifieduser, usertrainingtype)
select aartuserid,2019 schoolyear, email, course,now() createddate,(select id from aartuser where email='ats_dba_team@ku.edu') createduser, 
            now() modifieddate,(select id from aartuser where email='ats_dba_team@ku.edu') modifieduser, usertrainingtype from moodleupload;

INSERT INTO public.userpdtrainingdetail(
             userid, trainingcompleted, trainingcompletiondate, currentschoolyear, 
            createduser, createddate, modifieduser, modifieddate, organizationid)
select userid, trainingcompleted,'2018-06-12 14:31:32.326352+00' trainingcompletiondate,2019 currentschoolyear, 
            (select id from aartuser where email='ats_dba_team@ku.edu')createduser,now() createddate,(select id from aartuser where email='ats_dba_team@ku.edu') modifieduser,now() modifieddate, organizationid
             from userpdtrainingdetail;
